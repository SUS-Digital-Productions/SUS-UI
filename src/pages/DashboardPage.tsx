      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              Discover, browse, and manage your NFT collection on the WAX
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className={`hover:shadow-lg transition-all ${feature.color} ${
                ...
                >
                  ...
                  <CardContent>
                    <Button
                      ...
                      className="w-full"
                      variant={
                        isDisabled || isComingSoon ? "outline" : "default"
                      }
                    >
                      {isComingSoon ? (
        ...
        <Card className="bg-linear-to-r from-primary/10 to-primary/5 border-primary/20">
          <CardHeader>
            ...
            <CardDescription>
              Start exploring NFT collections or connect your wallet to manage
              your portfolio
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="border-t pt-8">
          <p className="text-sm text-muted-foreground text-center">
            SUS NFT Hub is a user-focused template for exploring and managing
            WAX blockchain NFTs.{" "}
